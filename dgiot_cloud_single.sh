...
wget http://dgiot-1253666439.file.myqcloud.com/dgiot_release/dgiot_43.tar.gz -O /data/dgiot.tar.gz
tar xf dgiot.tar.gz
cd  /data/dgiot
...
then
  ...
  wget http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/dgiot4.0/jdk-8u291-linux-x64.tar.gz
